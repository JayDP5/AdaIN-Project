...
def parse_arguments():
    ...
    parser.add_argument('--content_dir', type=str, default='E:\2025\Python\Projects\AI-nst-project-main\NST_Code\content_data',
                        help='Location of content dataset')
    parser.add_argument('--style_dir', type=str, default='E:\2025\Python\Projects\AI-nst-project-main\NST_Code\style_data',
                        help='Location of style dataset')
    parser.add_argument('--vgg', type=str, default='E:\2025\Python\Projects\AI-nst-project-main\NST_Code\vgg_normalised.pth',
